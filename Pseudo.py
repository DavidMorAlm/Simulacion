...
class Pseudo:
    ...
    def pMedias(self, a):
        ...
        if li <= p <= ls:
            print(
                f"No se puede rechazar que el conjunto ri tiene un valor esperado de 1/2 con un nivel de aceptacion de {(1 - a) * 100:.0f}%")
            result = True
        else:
    ...
    def pVarianza(self, a):
        ...
        if li <= var <= ls:
            print(
                f"No se puede rechazar que el conjunto ri tiene una varianza de 1/12 con un nivel de aceptacion de {(1 - a) * 100:.0f}%")
            result = True
        else:
    ...
    def pUniformidad(self, a):
        ...
        if estChi < chi:
            print(
                f"No se puede rechazar que el conjunto ri sigue una distribucion uniforme con un nivel de aceptacion de {(1 - a) * 100:.0f}%")
            result = True
        else:
    ...
    def pIndependencia(self, a):
        ...
        if (-1)*z < z0 < z:
            print(
                f"No se puede rechazar que el conjunto de ri es independiente con un nivel de aceptacion de {(1 - a) * 100:.0f}%")
            resultado = True
        else:
